...
// BEGIN CUT HERE
    public static void main(String[] args) {
        try {
            eq(0,(new LexStringWriter()).minMoves("aaa"),5);
            eq(1,(new LexStringWriter()).minMoves("ba"),4);
            eq(2,(new LexStringWriter()).minMoves("abba"),9);
            eq(3,(new LexStringWriter()).minMoves("acbbc"),12);
        } catch( Exception exx) {
