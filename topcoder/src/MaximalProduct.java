...
// BEGIN CUT HERE
    public static void main(String[] args) {
        try {
            eq(0,(new MaximalProduct()).maximalProduct(10, 3),36L);
            eq(1,(new MaximalProduct()).maximalProduct(10, 1),10L);
            eq(2,(new MaximalProduct()).maximalProduct(10, 10),1L);
            eq(3,(new MaximalProduct()).maximalProduct(13, 8),32L);
            eq(4,(new MaximalProduct()).maximalProduct(7, 2),12L);
        } catch( Exception exx) {
